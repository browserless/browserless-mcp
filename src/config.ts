...
export const DEFAULT_ACCOUNT_API_URL = 'https://api.browserless.io/graphql';
...
export function getConfig(): McpConfig {
  return {
    ...
    browserlessAccountApiUrl:
      process.env.BROWSERLESS_ACCOUNT_API_URL ?? DEFAULT_ACCOUNT_API_URL,
