...
| Command                               | Description            |
| ------------------------------------- | ---------------------- |
| `browserless_function init <name>`    | Create new project     |
| `browserless_function dev <file>`     | Start local dev server |
| `browserless_function publish <file>` | Deploy to Browserbase  |
