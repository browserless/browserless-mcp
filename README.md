...
| `MCP_ALLOWED_API_URL_HOSTS`  | No       | —                                        | Comma-separated hosts allowed for client-supplied API URL overrides, in addition to Browserless and the configured API host                                |
