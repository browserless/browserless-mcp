...
MCP (Model Context Protocol) server for [Browserless.io](https://browserless.io) — expose the Browserless super scraper API to LLM clients like Claude Desktop, Cursor, VS Code, and Windsurf.
...
| Tool | Description |
|------|-------------|
| `browserless_superscraper` | Scrape any webpage using cascading strategies (HTTP fetch, proxy, headless browser, captcha solving). Returns content as markdown, with optional screenshot and PDF. |
...
|-------------|-------------|
| `browserless://api-docs` | Super scraper API documentation |
