...
| `browserless_logs`         | Return the account's recent Browserless request logs. Use it to diagnose failed runs and page through the history available to the account's plan.                                                                                                                                                                                                                                 |
